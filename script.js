...
const weather_api_key = "924b7b2ade0193484fdbbd46b0717b7f"; // Replace with your OpenWeatherMap API key
const weather_api_url = "https://api.openweathermap.org/data/2.5/weather";

const content = create_element_groups("div", {
  class: "row",
...
function display_countries(data) {
  data.forEach((country) => {
    const countryCard = create_element_groups(
      "div",
  ...
  if (weatherDiv) {
    if (weatherData && weatherData.main) {
      weatherDiv.innerHTML = `
          <p><img src="clouds.png" style="height: 30px;width: 20px;">Temperature: ${Math.round(
            weatherData.main.temp
          )}°C</p>
          <p><img src="wind.png" style="height: 20px;"> wind: ${
            weatherData.wind.speed
          }km/h</p>
          <p><img src="humidity.png" style="height: 20px;"> humidity: ${
...
const serach_bar = create_element_groups("input", {
  type: "serach",
  id: "search-bar",
  placeholder: "type your country name",
  class: "form-control",
});
const serach_button = create_element_groups(
  "button",
  {},
...
const heading = create_element_groups(
  "h1",
  { id: "title", class: "text-center" },
  "Do you know your country weather"
);
